...
Next you'll need to download a tool called "jq". It allows json parsing through the command terminal. This is required for the run-tests-script.sh file, to extract the token and store it in a csv file.
